package com.hblearns77.udemy_lpa_javamasterclass.section14.demostubs.lambdaadvanced;
...
public class ChainingLambdasDemo {
    ...
    public static void demoChainingLmbdasANDComparing() {
        ...
        ConsoleStyler.styleOutput("Hi There 0" ,uCase.apply(name));


        UnaryOperator<String> lastName = s -> s.concat(" " + "BuchALKa");
        ConsoleStyler.styleOutput("Hi There 1" ,lastName.apply(uCase.apply(name)));
        Function<String,String> uCaseLastName = uCase.andThen(lastName);
        ConsoleStyler.styleOutput("Hi There 2 " ,uCaseLastName.apply(name));

        uCaseLastName = uCase.compose(lastName);
        ConsoleStyler.styleOutput("Hi There 3 " ,uCaseLastName.apply(name));
        ...
        UnaryOperator<String> f1 = (UnaryOperator<String>) uCase
                .andThen(s -> s.concat(" " + BUCHALKA))
                .andThen(s -> s.split(" "))
