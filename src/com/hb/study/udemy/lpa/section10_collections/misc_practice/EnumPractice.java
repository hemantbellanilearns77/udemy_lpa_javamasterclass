...
import com.hb.study.udemy.lpa.globalcommon.utils.ExecutionTiming;
import java.util.Random;

public class EnumPractice {
    private static ExecutionTiming executionTiming = new ExecutionTiming();
...
/*        System.out.println("Days of the week are: \n" +
        ...
        executionTiming.printExecutionTime();
