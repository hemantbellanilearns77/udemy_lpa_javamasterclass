package com.hb.study.udemy.lpa.section10_collections.exercises.exercise45;
...
public class Exercise45_PlaylistTestClass {
    ...
    public static String programOutputBegins = "\n" + "*".repeat(54) + " The Output of " +
            Exercise45_PlaylistTestClass.class.getSimpleName() + " is as below " + "*".repeat(54) + "\n";
    ...
    public static void main(String[] args) {
       ...
       // System.out.println("The album 'Stormbringer' looks like below: \n" + album ) ;
        ...
        System.out.print(asteriskSeparatorLine);
