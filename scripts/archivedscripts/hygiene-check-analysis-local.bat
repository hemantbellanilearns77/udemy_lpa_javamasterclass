...
if "%skip_checkstyle%"=="false" (
    ...
    call scripts\checkstyle-local.bat >> "%hygieneLogPath%" 2>&1
...
if "%skip_pmd%"=="false" (
    ...
    call scripts\pmd-local.bat>> "%hygieneLogPath%" 2>&1
...
if "%skip_jacoco%"=="false" (
    ...
    call scripts\jacoco-coverage-analysis-local.bat >> "%hygieneLogPath%" 2>&1
...
if "%skip_sonar%"=="false" (
    ...
    call scripts\sonar-scan-local.bat >> "%hygieneLogPath%" 2>&1
